 ...
 * @author Smittel
 */
import { Auth as emit, System } from "../../init/Connect.mjs";
// import { openSignup, openLogin, openSettings, openProfile, initialiseDesktop } from "../Handlers.mjs"
...
export function cookieLogin() {
    emit("cookielogin", document.cookie)
...
function removeLoadingAnimation() {
  let anim = Array.from(document.querySelector("div.blackout").childNodes)
    .filter((a) => a.tagName !== undefined);
  anim.forEach((a) => {
    a.dataset.fade = "out";
